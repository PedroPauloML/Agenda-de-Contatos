class ContactsController < ApplicationController
  ...
  before_action :set_option_for_select_kind, only: [:new, :edit, :update, :create]
  ...
  def create
    ...
    respond_to do |format|
      if @contact.save
        ...
        format.js { redirect_to @contact, notice: 'Contato criado com sucesso' }
  ...
  def destroy
    @contact.destroy
    respond_to do |format|
      format.html { redirect_to contacts_url, notice: 'Contato deletado com sucesso' }
